            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="col-span-1 md:col-span-2 p-6">
                  {/* Upcoming events list for mobile view */}
                  <div className="md:hidden mb-4">
                    <h3 className="font-medium text-lg mb-4">Événements à venir</h3>
                    <div className="space-y-4">
                      {events.map((event, index) => (
                        <div key={`mobile-${index}`} className="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-md transition-colors">
                  ...
                  {/* Event timeline visualization - placeholder for future calendar/timeline view */}
                  <div className="hidden md:block h-96 bg-gray-50 rounded-lg border border-dashed border-gray-200 flex items-center justify-center">
                    <div className="text-center text-gray-500">
                      <CalendarIcon className="mx-auto h-12 w-12 text-gray-300 mb-2" />
                      <p>Visualisation du calendrier à venir</p>
                      <p className="text-sm">Une vue plus détaillée sera disponible prochainement</p>
                    </div>
                  </div>
                </div>
